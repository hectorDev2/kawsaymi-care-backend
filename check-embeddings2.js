...
async function check() {
  ...
  // Verificar los embeddings almacenados
  ...
  result.rows.forEach((row, i) => {
    ...
    const embText = row.embedding_text || row.embedding;
    console.log(`    Embedding (texto): ${typeof embText === 'string' ? embText.slice(0, 100) + '...' : embText}`);
